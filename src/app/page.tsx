      ...
      <section className="py-24 bg-primary text-black text-center">
        <div className="container px-4 mx-auto">
            <h2 className="font-heading text-4xl md:text-6xl font-bold uppercase mb-6 text-black">
             ...
             <a href="/apply" className="inline-block bg-black text-white px-10 py-5 text-xl font-bold uppercase tracking-wide rounded-md hover:scale-105 transition-transform shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
                Secure My Spot
            </a>
        </div>
      </section>
