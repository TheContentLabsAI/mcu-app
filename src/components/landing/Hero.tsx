    ...
    <section className="relative min-h-[90vh] flex items-start pt-32 pb-20 md:items-center md:pt-20 md:pb-20 justify-center overflow-hidden bg-background">
      ...
      <div className="container relative z-20 px-4 md:px-6 text-center max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4">
          <Button size="lg" className="h-auto px-10 py-6 md:py-8 text-lg md:text-xl font-bold uppercase tracking-wide shadow-[0_0_20px_rgba(255,204,0,0.3)] hover:shadow-[0_0_40px_rgba(255,204,0,0.6)] transition-all bg-primary text-primary-foreground hover:bg-primary/90 whitespace-normal text-center" asChild>
            <Link href="/apply">
              Secure My Spot
            </Link>
          </Button>
